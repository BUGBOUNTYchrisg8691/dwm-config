...
static char_u *did_set_string_option(int opt_idx, char_u **varp, int new_value_alloced, char_u *oldval, char_u *errbuf, size_t errbuflen, int opt_flags, int *value_checked );
